								...
								<table>
									<tr>
										<td>
											<p>
												Hello,<br>
												Below is the YouTube link for {!! $project->client->company_name !!}.
											</p>
											<p>
												<b>Project:</b> <span style="color: #666;">{!! $project->title !!}</span><br>
                        <b>YouTube Link:</b>
                        <a href="{!! $youtube->link !!}">{!! $youtube->link !!}</a><br>
                        <b>ISCI:</b> <span style="color: #666;">{!! $youtube->title !!}</span>
											</p>
                      <p>
												<em>- Ken Moore</em><br>
